...
namespace UnityEngine.UI {
    ...
    /// </remarks>
    public abstract partial class LoopScrollRectBase : UIBehaviour, IInitializePotentialDragHandler, IBeginDragHandler, IEndDragHandler, IDragHandler, IScrollHandler, ICanvasElement, ILayoutElement, ILayoutGroup {
        // 用于填充项的滚动数据源。
        [HideInInspector]
        [NonSerialized]
