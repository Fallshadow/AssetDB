...
[Serializable]
public class EffectUIPlayer
{
    /// <summary>
    /// 目标控件
    /// </summary>
    [SerializeField] public Graphic Target;
    /// <summary>
    /// 显示名称
    /// </summary>
    ...
    /// 动画值类型
    /// </summary>
    [SerializeField] public AnimationValueType ValueType;
    /// <summary>
    /// 动画曲线
    /// </summary>
    ...
    /// 动画开始值
    /// </summary>
    [SerializeField] public float FloatStartValue;
    /// <summary>
    /// 动画结束值
    /// </summary>
    [SerializeField] public float FloatEndValue;
    /// <summary>
    /// 动画开始值
    /// </summary>
    [SerializeField] public Vector4 Vector4StartValue;
    /// <summary>
    /// 动画结束值
    /// </summary>
    [SerializeField] public Vector4 Vector4EndValue;
    /// <summary>
    /// 动画开始值
    /// </summary>
    [SerializeField] public Color ColorStartValue;
    /// <summary>
    /// 动画结束值
    /// </summary>
    [SerializeField] public Color ColorEndValue;
    /// <summary>
    /// 动画是否循环
    /// </summary>
    ...
    /// 动画循环模式
    /// </summary>
    [SerializeField] public AnimationLoopMode LoopMode;
    /// <summary>
    /// 动画持续时间
    /// </summary>
    ...
    /// 初始时自动播放
    /// </summary>
    [SerializeField] public bool IsPlayOnStart;
    ...
    public EffectUIPlayer(Graphic target, string propertyName, string displayName, AnimationValueType valueType) {
        Target = target;
