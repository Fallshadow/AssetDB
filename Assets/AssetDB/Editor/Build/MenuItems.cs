...
namespace FallShadow.Asset.Editor {
    public class MenuItems {
        ...
        [MenuItem("Dev Tools/GenerateFileListAndCopyToStreamingAssets")]
        private static void GenerateFileListAndCopyToStreamingAssets() {
            // 忽略本身的 files.txt 及 dll 相关文件
            Command.GenerateFileListAndCopyToStreamingAssets(Builder.DefaultOutput, Application.streamingAssetsPath, new[] { ".dll" }, new[] { "!files.txt", "!**/*.dll" });
        }
    }
}
